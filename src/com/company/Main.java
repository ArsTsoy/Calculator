...
//            String[] numbers = calcApp.getNumbers();
//            for (String number : numbers) {
//                System.out.print(number + " ");
//            }

//            System.out.println(calcApp.getArithmethicOperation());
            try {
...
class Calculate {
    ...
    private final static String arithmethicOperationPattern = "[\\/\\+\\-\\*]{1}";
    ...
    private String[] getNumbers() {
        return given.split(arithmethicOperationPattern);
    }

    private ConvertResult toInt(String numberAsStr) throws Exception {
        //TODO: возможны римские числа, надо написать mapper
        try {
    ...
    private ArithmethicOperation getArithmethicOperation() throws Exception {
        ...
        Matcher matcher = Pattern
                .compile(arithmethicOperationPattern)
                .matcher(this.given);
        String operation = "";
        if (matcher.find()) {
